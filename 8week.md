...
>Плагин NgRx ESLint ничем не отличается и продвигает ключевые концепции для создания поддерживаемого проекта. Он состоит из правил @ngrx/store, @ngrx/effects и @ngrx/component-store, а также нескольких предварительно настроенных конфигураций.
